...
const faqs = [
  { q: 'How do I connect a new ad platform?', a: 'Go to Integrations → click Connect next to the platform. You'll be redirected to authenticate via OAuth.' },
  ...
  { q: 'How do I set a budget alert?', a: 'Go to Settings → Notifications and enable "Budget alerts". Alerts trigger at 80% utilisation by default.' },
];
